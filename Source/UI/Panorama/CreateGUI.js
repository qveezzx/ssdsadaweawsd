...
u8R"(
  ...
  createTextEntry(skinsSection, "AK-47 Paint Kit", 'skins_ak47', '0');
  separator(skinsSection);
  createTextEntry(skinsSection, "M4A4 Paint Kit", 'skins_m4a4', '0');
  separator(skinsSection);
  createTextEntry(skinsSection, "M4A1-S Paint Kit", 'skins_m4a1s', '0');
  separator(skinsSection);
  createTextEntry(skinsSection, "AWP Paint Kit", 'skins_awp', '0');

  var musicSection = createSection(skins, 'Music Kits');
  createTextEntry(musicSection, "Music Kit ID", 'skins_music_kit', '0');
